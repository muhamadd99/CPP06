...
int	main(int ac, char **av)
{
	if (ac != 2)
	{
		std::cout << "Please input a literal char/int/float/double" << std::endl;
		return (1);
	}
...
//     ScalarConverter::convert("-21474836248"); // INT_MIN
...
//     ScalarConverter::convert("123.0");      // Double without f //regard as integer
